...
I was able to create the for loop in order to get the Savior names and find the word count in between. I can't figure out how to create a dataset with those vectors in order to calculate the average word count and then graph it.
